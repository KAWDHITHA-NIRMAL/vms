...
start_vm() {
    ...
    if load_vm_config "$vm_name"; then
        ...
        if [[ "$GUI_MODE" == true ]]; then
            ...
            qemu_cmd+=(-vga virtio -display vnc=0.0.0.0:$vnc_port)
        else
...
declare -A OS_OPTIONS=(
    ...
    ["Windows 10"]="windows|10|https://archive.org/download/en-us_windows_10_consumer_editions_version_22h2_updated_feb_2023_x64_dvd_c29e4bb3/en-us_windows_10_consumer_editions_version_22h2_updated_feb_2023_x64_dvd_c29e4bb3.iso|win10|admin|password"
